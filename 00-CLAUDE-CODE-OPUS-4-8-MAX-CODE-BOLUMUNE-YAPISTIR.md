# PALA OS v28 — OPUS 4.8 MAX / CLAUDE CODE CODE BÖLÜMÜNE YAPIŞTIR
...
If the UI lets you choose model/effort manually, choose Opus and Max for the planning/architecture phase. Keep token economy honest: max effort can spend more. Use high/xhigh/sonnet for cheaper implementation steps only when evidence says it is safe.
